...
export const frontendDeveloperTemplate: Template = {
  ...
  blocks: [
    ...
    { kind: 'widget', libId: 'fw-react', type: 'tech-icon', name: 'React', settings: { size: 40, link: 'https://react.dev', align: 'left', slug: 'react' } },
    ...
    { kind: 'widget', libId: 'fw-nextjs', type: 'tech-icon', name: 'Next.js', settings: { size: 40, link: 'https://nextjs.org', align: 'left', slug: 'nextjs' } },
    { kind: 'text', className: 'md-text', html: '<strong>Styling</strong>' },
    { kind: 'widget', libId: 'fw-tailwind', type: 'tech-icon', name: 'Tailwind CSS', settings: { size: 40, link: 'https://tailwindcss.com', align: 'left', slug: 'tailwind' } },
    { kind: 'widget', libId: 'fw-sass', type: 'tech-icon', name: 'Sass', settings: { size: 40, link: 'https://sass-lang.com', align: 'left', slug: 'sass' } },
